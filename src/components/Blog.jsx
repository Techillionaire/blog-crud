...
const Blog = ({ author, title, body, onDelete}) => {
  return (
    <Link>
      <article className=" border rounded p-5 bg-slate-100 mt-6">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <div  className="flex">
              <div className="w-10 h-10 hover:bg-gray-200 rounded-full flex items-center justify-center hover:text-pink-600 cursor-pointer   transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300">
